...
-- ─────────────────────────────────────────────────────────────────────────────
-- [8/8] 20260922010000_dedupe_reading_sessions.sql
-- Sesiones de lectura duplicadas por pulsar "Guardar" repetido sin cambiar
-- "Terminé en" (pico de 43 páginas el 09/09/2026). Conserva la más antigua de
-- cada grupo idéntico y reconstruye el total diario en daily_area_stats.
