...
// High Performance Mode - Starts at 4:00 AM
const HIGH_PERFORMANCE_BLOCKS: RoutineBlock[] = [
...
// Normal Performance Mode - Starts at 6:00 AM
const NORMAL_PERFORMANCE_BLOCKS: RoutineBlock[] = [
...
// Low Performance Mode - Starts at 6:30 AM
const LOW_PERFORMANCE_BLOCKS: RoutineBlock[] = [
...
// Recovery/Rest Mode - Flexible start
const RECOVERY_MODE_BLOCKS: RoutineBlock[] = [
...
export const PERFORMANCE_MODES: PerformanceMode[] = [
  {
    ...
    blocks: HIGH_PERFORMANCE_BLOCKS,
  },
  {
    id: "normal",
    ...
    blocks: NORMAL_PERFORMANCE_BLOCKS,
  },
  {
    id: "bajo-rendimiento",
  ...
  },
  {
    ...
    blocks: RECOVERY_MODE_BLOCKS,
  },
];

export const getModeById = (modeId: string): PerformanceMode | undefined => {
  return PERFORMANCE_MODES.find(mode => mode.id === modeId);
};

export const getBlocksForMode = (modeId: string): RoutineBlock[] => {
  const mode = getModeById(modeId);
  return mode?.blocks || NORMAL_PERFORMANCE_BLOCKS;
};
