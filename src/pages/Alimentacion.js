...
export default function Alimentacion() {
    ...
    const mealPhotos = (todayEntry?.meal_photos || {});
    ...
    return (_jsx("div", { className: "min-h-screen bg-gradient-to-b from-background to-muted/20 p-4 md:p-8 pt-24", children: _jsxs("div", { className: "max-w-4xl mx-auto space-y-6", children: [_jsxs("div", { className: "text-center space-y-2", children: [_jsxs("div", { className: "flex items-center justify-center gap-2", children: [_jsx("div", { className: "p-3 rounded-xl bg-gradient-to-br from-amber-500/20 to-orange-500/10", children: _jsx(Utensils, { className: "h-7 w-7 text-amber-500" }) }), _jsx("h1", { className: "text-3xl md:text-4xl font-bold bg-gradient-to-r from-amber-500 to-orange-500 bg-clip-text text-transparent", children: "Alimentaci\u00F3n" })] }), _jsx("p", { className: "text-sm text-muted-foreground", children: "Registro fotogr\u00E1fico y macros" })] }), _jsxs("div", { className: "flex items-center justify-center gap-4", children: [_jsx(Button, { variant: "ghost", size: "icon", onClick: () => setSelectedDate(d => subDays(d, 1)), children: _jsx(ChevronLeft, { className: "h-4 w-4" }) }), _jsx("span", { className: "text-lg font-semibold capitalize", children: format(selectedDate, "EEEE d 'de' MMMM", { locale: es }) }), _jsx(Button, { variant: "ghost", size: "icon", onClick: () => setSelectedDate(d => new Date(d.getTime() + 86400000)), children: _jsx(ChevronRight, { className: "h-4 w-4" }) })] }), _jsxs(Card, { className: "p-4", children: [_jsxs("div", { className: "flex items-center justify-between mb-3", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Flame, { className: "h-5 w-5 text-orange-500" }), _jsx("span", { className: "text-sm font-bold", children: "Resumen Diario" })] }), _jsxs("span", { className: cn("text-xl font-bold", todayTotals.calories > nutritionAI.DAILY_GOALS.calories ? "text-red-500" : "text-foreground"), children: [todayTotals.calories, _jsxs("span", { className: "text-xs text-muted-foreground font-normal ml-1", children: ["/ ", nutritionAI.DAILY_GOALS.calories] })] })] }), _jsxs("div", { className: "grid grid-cols-1 gap-2", children: [_jsx(MacroProgressBar, { label: "Calor\u00EDas", current: todayTotals.calories, goal: nutritionAI.DAILY_GOALS.calories, icon: _jsx(Flame, { className: "h-3 w-3 text-orange-500" }), color: "bg-orange-500" }), _jsxs("div", { className: "grid grid-cols-3 gap-3", children: [_jsx(MacroProgressBar, { label: "Prote\u00EDna", current: todayTotals.protein, goal: nutritionAI.DAILY_GOALS.protein, icon: _jsx(Beef, { className: "h-3 w-3 text-red-400" }), color: "bg-red-400" }), _jsx(MacroProgressBar, { label: "Carbos", current: todayTotals.carbs, goal: nutritionAI.DAILY_GOALS.carbs, icon: _jsx(Wheat, { className: "h-3 w-3 text-amber-400" }), color: "bg-amber-400" }), _jsx(MacroProgressBar, { label: "Grasa", current: todayTotals.fat, goal: nutritionAI.DAILY_GOALS.fat, icon: _jsx(Apple, { className: "h-3 w-3 text-green-400" }), color: "bg-green-400" })] })] })] }), _jsx(Card, { className: "p-4", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx(Droplets, { className: "h-5 w-5 text-blue-500" }), _jsx("span", { className: "font-medium", children: "Hidrataci\u00F3n" }), _jsxs(Badge, { variant: "secondary", children: [waterCount, "/7 vasos"] })] }) }), _jsxs(Tabs, { defaultValue: "today", children: [_jsxs(TabsList, { className: "grid grid-cols-4", children: [_jsx(TabsTrigger, { value: "today", children: "Hoy" }), _jsx(TabsTrigger, { value: "week", children: "Semana" }), _jsx(TabsTrigger, { value: "recipes", children: "Recetas" }), _jsx(TabsTrigger, { value: "plan", children: "Planificar" })] }), _jsx(TabsContent, { value: "today", className: "space-y-3 mt-4", children: MEALS.map(meal => {
                                ...
                                return (_jsx(Card, { className: "overflow-hidden", children: _jsx("div", { className: "p-4", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("p", { className: "font-medium text-sm", children: meal.name }), _jsx("p", { className: "text-xs text-muted-foreground", children: meal.time }), mealFoods.length > 0 && (_jsx("div", { className: "flex gap-2 mt-1 flex-wrap", children: mealFoods.map(f => (_jsxs(Badge, { variant: "secondary", className: "text-[10px] gap-1", children: [f.description, " ~", f.estimated_calories, " kcal", _jsx("button", { onClick: () => nutritionAI.deleteMeal(f.id), className: "hover:text-destructive ml-0.5", children: _jsx(Trash2, { className: "h-2.5 w-2.5" }) })] }, f.id))) })), (mealCals > 0) && (_jsxs("div", { className: "flex gap-3 mt-1.5 text-[10px] text-muted-foreground", children: [_jsxs("span", { children: [Math.round(mealCals), " kcal"] }), _jsxs("span", { children: ["P: ", Math.round(mealProtein), "g"] }), _jsxs("span", { children: ["C: ", Math.round(mealCarbs), "g"] }), _jsxs("span", { children: ["G: ", Math.round(mealFat), "g"] })] }))] }), _jsxs("div", { className: "flex items-center gap-2 shrink-0", children: [isToday && (_jsx("div", { className: "flex flex-col gap-1", children: _jsxs("div", { className: "flex gap-1", children: [_jsx(Input, { placeholder: "\u00BFQu\u00E9 comiste?", value: foodInputs[meal.id] || "", onChange: e => setFoodInputs(p => ({ ...p, [meal.id]: e.target.value })), className: "h-7 w-28 text-[10px]", onKeyDown: async (e) => {
                                                                        ...
                                                                        }, children: _jsx(Plus, { className: "h-3 w-3" }) })] }) })), photo ? (_jsx("img", { src: photo, alt: meal.name, className: "h-14 w-14 rounded-lg object-cover" })) : (_jsxs(Button, { variant: "outline", size: "sm", onClick: () => handlePhotoUpload(meal.id), disabled: uploading, className: "gap-1 h-7 text-[10px]", children: [_jsx(Camera, { className: "h-3 w-3" }), "Foto"] }))] })] }) }) }, meal.id));
                            }) }), _jsx(TabsContent, { value: "week", className: "mt-4", children: _jsx("div", { className: "space-y-4", children: weekDays.map(day => {
                                    ...
                                    return (_jsxs(Card, { className: "p-4", children: [_jsx("p", { className: "text-sm font-semibold capitalize mb-2", children: format(day, "EEEE d", { locale: es }) }), photoList.length > 0 ? (_jsx("div", { className: "flex gap-2 overflow-x-auto pb-2", children: photoList.map(([mealId, url]) => (_jsxs("div", { className: "shrink-0", children: [_jsx("img", { src: url, alt: mealId, className: "h-16 w-16 rounded-lg object-cover" }), _jsx("p", { className: "text-[10px] text-center text-muted-foreground mt-1", children: MEALS.find(m => m.id === mealId)?.name || mealId })] }, mealId))) })) : (_jsx("p", { className: "text-xs text-muted-foreground", children: "Sin fotos registradas" }))] }, dayStr));
                                }) }) }), _jsx(TabsContent, { value: "recipes", className: "mt-4", children: _jsx(RecipeManager, {}) }), _jsx(TabsContent, { value: "plan", className: "mt-4", children: _jsx(WeeklyMealPlan, {}) })] })] }) }));
}
