...
import { ResultadosAnual } from '@/components/resultados/ResultadosAnual';
...
export default function AnualView() {
    ...
    return (_jsx("div", { className: "min-h-screen bg-[radial-gradient(ellipse_at_top,_hsl(var(--primary)/0.04)_0%,_transparent_50%)] p-4 md:p-6 pt-20 pb-24", children: _jsxs("div", { className: "max-w-5xl mx-auto space-y-5", children: [_jsx("div", { className: "flex justify-center", children: _jsx(EsfuerzoResultadosToggle, { value: viewMode, onChange: setViewMode }) }), _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsxs("h1", { className: "text-2xl font-bold tracking-tight", children: ["A\u00F1o ", year] }), _jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Vista anual \u00B7 acumulado de los 4 trimestres" })] }), _jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Button, { variant: "ghost", size: "icon", onClick: () => setYear(y => y - 1), children: _jsx(ChevronLeft, { className: "w-4 h-4" }) }), _jsx(Button, { variant: "outline", size: "sm", onClick: () => setYear(new Date().getFullYear()), children: "Actual" }), _jsx(Button, { variant: "ghost", size: "icon", onClick: () => setYear(y => y + 1), children: _jsx(ChevronRight, { className: "w-4 h-4" }) })] })] }), viewMode === 'plan' ? (_jsxs("div", { className: "space-y-4", children: [_jsx("div", { className: "grid grid-cols-4 gap-2.5", children: quarterStats.map(q => {
                            ...
                            }) }), _jsx(PeriodSections, { scope: "year", year: year, quarter: currentQuarter })] })) : viewMode === 'esfuerzo' ? (_jsxs(_Fragment, { children: [_jsx(PeriodControlSection, { scope: "year", start: new Date(year, 0, 1), end: new Date(year, 11, 31) }), _jsx(PeriodSections, { scope: "year", year: year, quarter: currentQuarter })] })) : viewMode === 'resultados' ? (_jsx(ResultadosAnual, { year: year })) : (_jsx(AutocriticaSection, { start: new Date(year, 0, 1), end: new Date(year, 11, 31), scope: 'year' }))] }) }));
}
