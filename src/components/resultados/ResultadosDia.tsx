...
/* Fila por área: columna planificado + columna resultado */
function AreaRow({ title, color, plan, result }: {
  title: string;
  color?: string;
  ...
  return (
    <div className="grid gap-4 lg:grid-cols-2">
      <AreaCard title={`${title} — lo que hay que hacer`} color={color}>{plan}</AreaCard>
  ...
  return (
    <div className="space-y-5">
      ...
      <AreaRow
        ...
        plan={
          <ul className="space-y-1.5">
            <CheckItem>"Hábitos Atómicos" — pags. 200–230</CheckItem>
            <CheckItem>Libros plan de hoy: 25 páginas mínimas</CheckItem>
          </ul>
        }
        result={
          <>
      ...
      <AreaRow
        ...
        result={
          <div className="space-y-1">
            <ResultRow label="Bug del guardado" value="Corregido" ok />
            <ResultRow label="Sección hero" value="En curso" pending />
            <ResultRow label="Avance general del proyecto" value="65%" />
          </div>
        }
      />
      ...
      <AreaRow
        ...
        plan={
          <ul className="space-y-1.5">
            <CheckItem>"Vals No. 2" — practicar del min 1:00 al 2:30</CheckItem>
            <CheckItem>Escalas 10 min</CheckItem>
          </ul>
        }
        result={
          <>
            <div className="flex items-end justify-between">
              <div>
                ...
                <p className="text-[10px] text-muted-foreground">"Vals No. 2" · aprendida hasta el minuto</p>
              </div>
      ...
      <AreaRow
        ...
        plan={
          <ul className="space-y-1.5">
            <CheckItem>3 partidas planificadas</CheckItem>
            <CheckItem done>15 min de tácticas</CheckItem>
          </ul>
        }
        result={
          <div className="flex items-center gap-4">
