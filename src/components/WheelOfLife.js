...
export function WheelOfLife({ values = DEFAULT_VALUES, values2, labels = DEFAULT_LABELS, average: avgProp, average2: avg2Prop, view = "ambos", loading, }) {
    const cx = 200;
    const cy = 200;
    const maxR = 145;
